...
//setting active and not active list
...
function createTask(name){
    ...
    return{ id: Date.now().toString(), name: name, dueDate: due.toLocaleDateString() , complete: false}
}
...
var $projMenu = document.getElementsByClassName("proj-list")[0];
var $projList = Array.from(document.getElementsByClassName("proj-list")[0].children);
const $downArrow = document.getElementById("down_arrow");
var $navList = Array.from(document.getElementsByClassName("nav_list")[0].children);
var $sidebarBtn = document.getElementsByClassName("sidebarBtn")[0];
